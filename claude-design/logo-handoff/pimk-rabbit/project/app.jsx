    ...
    <div data-screen-label="Pink Rabbit DS + Prototype" className="page-wrap">
      ...
      {/* 05. 인증 */}
        ...
        <CategoryBlock
          ...
          title="커뮤니티"
          path="/m/community/*"
          subtitle="3개 탭 — 🙋‍♂️ 구인 (매장이 딜러/매니저 모집) · 💼 구직 (딜러 이력서) · 🃏 중고거래 (홀덤 용품)"
          hint="탭을 눌러 전환 / 우하단 핑크 + 버튼은 글쓰기 FAB"
        >
          <CommunityScreen />
        </CategoryBlock>
        ...
        <CategoryBlock
          ...
          title="스플래시"
          path="앱 실행 시 1.5초"
          subtitle="브랜드 메인 · 미니멀 · 다크 프로 · LIVE 알림 — 4종 변형"
          hint="실시간 LIVE 카운트 / 카운트다운 타이머가 동작합니다"
          wide
        >
          <SplashCatalog />
        </CategoryBlock>
