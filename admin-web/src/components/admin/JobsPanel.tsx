  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6 gap-3">
        <div>
          <div className="section-title" style={{ color: 'var(--brand)' }}>RECRUITMENT</div>
          <h1 className="h2" style={{ color: 'var(--text-1)' }}>💼 구인 관리</h1>
          <p className="text-sm mt-1" style={{ color: 'var(--text-2)' }}>{storeName} · 채용 공고</p>
        </div>
        <button
          onClick={openCreate}
